...
class si_widget_social extends WP_Widget {
    ...
    {
        parent::__construct('si_widget_social', 'SportIsland - Социальный виджет', 
        [
            'name' => 'SportIsland - Социальный виджет',
            'description' => 'Выводит соц.сети'
        ]);
    }
...
private $socials = [
   ...
   '
    ...
    // переопределяем функции из родительского класса. как будет выводиться для админа
...
<?php    
    ...
    {
        $my_elem = $instance['si_slug'];
        $link = $instance['si_link'];
        $my_text = $this->socials[$my_elem][0];
        $my_svg = $this->socials[$my_elem][1];
        ?>
      <a target="_blank" href="<?=$link?>" class="widget-social-links <?=$my_elem?>">
              <span class="sr-only"> Мы в <?php echo $my_text ?> </span>
              <?php echo $my_svg ?>
      </a>
        <?php
    }
